...
// Negative = ancestors (-1=parents, -2=grandparents, -3=great grandparents, -4=great-great)
// 0 = same generation as user, Positive = descendants
const RELATION_GEN: Record<string, number> = {
  'Great Grand Paternal Father':  -3,
  'Great Grand Paternal Mother':  -3,
  'Great Grand Maternal Father':  -3,
  'Great Grand Maternal Mother':  -3,
  'Grand Paternal Father':        -2,
  'Grand Paternal Mother':        -2,
  'Grand Maternal Father':        -2,
  'Grand Maternal Mother':        -2,
  Father:  -1,
  Mother:  -1,
  'Father-in-law':  -1,
  'Mother-in-law':  -1,
  'Grand Paternal Father-in-law': -2,
  'Grand Paternal Mother-in-law': -2,
  'Grand Maternal Father-in-law': -2,
  'Grand Maternal Mother-in-law': -2,
  'Great Grand Paternal Father-in-law': -3,
  'Great Grand Paternal Mother-in-law': -3,
  'Great Grand Maternal Father-in-law': -3,
  ...
  'Grand Son':       2,
  'Grand Daughter':  2,
  "Spouse's Grand Son": 2,
  "Spouse's Grand Daughter": 2,
  'Great Grand Son':      3,
  'Great Grand Daughter': 3,
  "Spouse's Great Grand Son": 3,
...
const RELATION_SORT: Record<string, number> = {
  ...
  'Father-in-law': 2,
  'Mother-in-law': 3,
  'Grand Paternal Father-in-law': 0,
  'Grand Paternal Mother-in-law': 1,
  'Grand Maternal Father-in-law': 2,
  'Grand Maternal Mother-in-law': 3,
  'Great Grand Paternal Father-in-law': 0,
  'Great Grand Paternal Mother-in-law': 1,
  'Great Grand Maternal Father-in-law': 2,
  'Great Grand Maternal Mother-in-law': 3,
  Brother: 0,
  Sister:  1,
  'Married Brother': 2,
  ...
  'Grand Daughter': 1,
  "Spouse's Grand Son": 2,
  "Spouse's Grand Daughter": 3,
  'Great Grand Son':      0,
  'Great Grand Daughter': 1,
  "Spouse's Great Grand Son": 2,
  "Spouse's Great Grand Daughter": 3,
}
