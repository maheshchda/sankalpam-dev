...
export default function PoojaReadinessPage({ params, searchParams }: Props) {
      ...
      <div className="mx-auto max-w-3xl rounded-xl bg-white p-8 shadow">
        {fromCalendar && (
          <div className="mb-6">
            <Link
              href="/pooja-calendar"
              className="inline-flex items-center rounded-md bg-indigo-700 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-800"
            >
              Go Back
            </Link>
          </div>
