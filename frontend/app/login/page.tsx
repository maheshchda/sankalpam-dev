        ...
        <div className="sacred-card p-8">
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 flex items-center justify-center min-w-[44px] pr-1 text-stone-400 hover:text-gold-600 focus:outline-none z-20 touch-manipulation"
                  tabIndex={-1}
            ...
            <button
              ...
              disabled={loading}
              suppressHydrationWarning
              className="gold-btn w-full py-2.5 flex items-center justify-center gap-2 disabled:opacity-80"
            >
              {loading && (
                <svg className="animate-spin h-5 w-5 text-sacred-800" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" aria-hidden="true">
