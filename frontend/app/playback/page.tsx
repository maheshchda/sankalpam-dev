    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-50 to-orange-100">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Generating Sankalpam...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-50 to-orange-100">
        <div className="text-center">
          ...
          <Link href="/pooja" className="px-4 py-2 bg-amber-600 text-white rounded-md">
            Go Back
          </Link>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="mb-6 text-center">
            <h2 className="text-3xl font-bold mb-2">Sankalpam</h2>
            <p className="text-gray-600">Nearby River: {sankalpam.nearby_river}</p>
          </div>
          ...
          <div className="mb-6 text-center">
            ...
            {!audioUrl && (
              <p className="text-sm text-gray-500 mt-2">
                Audio generation in progress... Visual playback available
              </p>
            )}
          </div>

          <div className="bg-amber-50 rounded-lg p-6 min-h-[400px]">
