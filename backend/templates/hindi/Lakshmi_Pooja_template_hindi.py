"""
Hindi Sankalpam Template Generator for Lakshmi Pooja (Devanagari).
...
async def generate_sankalpam_text(data: Dict) -> str:
    """Generate Hindi (Devanagari) sankalpam text for Lakshmi Pooja."""
    lines = []
...
async def _get_panchang_from_divine_api(data: Dict) -> Dict[str, str]:
    ...
    try:
        ...
        print(f"[Lakshmi Hindi Template] Error fetching from Divine API: {e}")
        return _get_fallback_panchang(data)
